...
export class InitDatebase1753619421457 implements MigrationInterface {
  name = 'InitDatebase1753619421457';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "article" ADD "image" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "article" ADD "categoryId" uuid NOT NULL`,
    );
